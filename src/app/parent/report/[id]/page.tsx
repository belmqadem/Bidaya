  ...
  if (!report) {
    return (
      <div className="flex flex-col items-center gap-3 py-20">
        ...
        <p className="text-muted-foreground text-sm">Signalement introuvable.</p>
        <Link href="/parent">
    ...
    <div className="space-y-5">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          <h1 className="text-lg font-semibold">Signalement</h1>
          ...
          <CardContent className="space-y-3 pt-0">
            ...
            <div className="flex items-center gap-2 rounded-lg bg-purple-50 px-3 py-2.5">
              ...
              <span className="text-muted-foreground text-xs">
                Communiquez ce code à votre pharmacie
              </span>
            </div>
      ...
      <Card>
        <CardHeader className="pb-3">
          <CardTitle className="text-sm">Échanges</CardTitle>
        </CardHeader>
        <CardContent className="space-y-3 pt-0">
